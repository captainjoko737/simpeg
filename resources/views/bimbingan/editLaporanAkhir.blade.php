      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => 'putBimbinganLaporanAkhir','files'=>true, 'method' => 'PUT')) !!}
            <div class="box-body">  
...
<script type="text/javascript">
    ...
    var jenisBimbingan = '{!! $result->jenis_bimbingan !!}';
    var periode = '{!! $result->periode !!}';
    var semester = '{!! $result->semester !!}';
    document.getElementById("jenis_bimbingan").value = jenisBimbingan;
