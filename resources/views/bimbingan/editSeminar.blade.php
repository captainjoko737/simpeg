      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => 'putBimbinganSeminar','files'=>true, 'method' => 'PUT')) !!}
            <div class="box-body">  
                ...
                <div class="form-group hide">
                  <label>id Bimbingan Seminar</label>
                  <input type="text" class="form-control" required id="id_bimbingan_seminar" name="id_bimbingan_seminar" value="{{ $result->id_bimbingan_seminar }}">
                </div>

                <div class="form-group">
                  <label>Nama Bimbingan</label>
                  <input type="text" class="form-control" required id="nama_bimbingan" name="nama_bimbingan" placeholder="Masukkan Nama Bimbingan" value="{{ $result->nama_bimbingan }}">
                </div>
