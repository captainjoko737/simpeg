      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => 'putBimbinganKkp','files'=>true, 'method' => 'PUT')) !!}
            <div class="box-body">  
                ...
                <div class="form-group" hidden>
                  <label>id Bimbingan KKP</label>
                  <input type="text" class="form-control" required id="id_bimbingan_kkp" name="id_bimbingan_kkp" value="{{ $result->id_bimbingan_kkp }}">
                </div>
