              ...
              <table class="table table-hover">
                ...
                @foreach ($result as $key => $value)
                  ...
                  <tr>
                    ...
                    <td><button class="btn btn-sm btn-info" onclick="edit({{$value->id_bimbingan_kkp }})"><i class="fa fa-pencil"></i> Edit</button> <button class="btn btn-sm btn-danger" onclick="ButtonDelete({{ $value->id_bimbingan_kkp }})"><i class="fa fa-trash"></i> Delete</button></td>
                  </tr>
...
<script type="text/javascript">
    ...
    function add() {
        location.href='/bimbingan/kkp/add';
    }

    function edit(id_bimbingan_kkp) {
        console.log('EDIT ', id_bimbingan_kkp);
        location.href='/bimbingan/kkp/edit/'+id_bimbingan_kkp;
    }
    ...
    function ButtonDelete(id_bimbingan_kkp) {
        console.log(id_bimbingan_kkp);

        selectedID = id_bimbingan_kkp;
    ...
    function deleteConfirm() {
        ...
        var data = {
                "id_bimbingan_kkp" : selectedID,
                "_token" : _token};

          $.ajax({
             type: 'delete',
             url: '{{url("/bimbingan/kkp/delete")}}',
             data: data,
