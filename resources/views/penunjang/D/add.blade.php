      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => 'postPenunjangD','files'=>true)) !!}
            <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="sel1" required id="tingkat" name="tingkat">
                ...
                <div class="form-group" hidden>
                  ...
                  <input type="text" class="form-control" required id="kategori" name="kategori" value="D">
                </div>
