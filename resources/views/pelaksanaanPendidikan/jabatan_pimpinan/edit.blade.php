      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => 'putPendidikanJabatan','files'=>true, 'method' => 'PUT')) !!}
            <div class="box-body">  
                ...
                <div class="form-group hide">
                  <label>id Jabatan Pimpinan</label>
                  <input type="text" class="form-control" required id="id_jabatan_pimpinan" name="id_jabatan_pimpinan" value="{{ $result->id_jabatan_pimpinan }}">
                </div>
