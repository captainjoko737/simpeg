                ...
                <tbody>
                  @foreach ($result as $key => $value)
                    ...
                    <tr>
                      ...
                      <td><button class="btn btn-sm btn-info" onclick="edit({{$value->id_jabatan_pimpinan}})"><i class="fa fa-pencil"></i></button> <button class="btn btn-sm btn-danger" onclick="ButtonDelete({{ $value->id_jabatan_pimpinan }})"><i class="fa fa-trash"></i></button></td>
                    </tr>
...
<script type="text/javascript">
    ...
    function add() {
        location.href='/pendidikan/jabatan/add';
    }

    function edit(id) {
        console.log('EDIT ', id);
        location.href='/pendidikan/jabatan/edit/'+id;
    }
    ...
    function deleteConfirm() {
        ...
        var data = {
                "id_jabatan_pimpinan" : selectedID,
                "_token" : _token};

          $.ajax({
             type: 'delete',
             url: '{{url("/pendidikan/jabatan/delete")}}',
             data: data,
