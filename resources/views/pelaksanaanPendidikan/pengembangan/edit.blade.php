      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => 'putPengembangan','files'=>true, 'method' => 'PUT')) !!}
            <div class="box-body">  
                ...
                <div class="form-group hide">
                  <label>id Pengembangan</label>
                  <input type="text" class="form-control" required id="id_pengembangan_diri" name="id_pengembangan_diri" value="{{ $result->id_pengembangan_diri }}">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" required id="jam" name="jam" placeholder="Masukkan Jam Kegiatan" value="{{ $result->jam }}">
                </div>
