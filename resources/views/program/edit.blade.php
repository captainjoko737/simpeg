      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => 'putProgramKuliah','files'=>true, 'method' => 'PUT')) !!}
            <div class="box-body">  
                ...
                <div class="form-group" hidden>
                  <label>id</label>
                  <input type="text" class="form-control" required id="id_program_kuliah" name="id_program_kuliah" value="{{ $result->id_program_kuliah }}">
                </div>
