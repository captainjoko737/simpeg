              ...
              <table class="table table-hover">
                ...
                @foreach ($result as $key => $value)
                  ...
                  <tr>
                    ...
                    <td class="text-center"> <button class="btn btn-sm btn-info" onclick="edit({{$value->id_program_kuliah }})"><i class="fa fa-pencil"></i> Edit</button> <button class="btn btn-sm btn-danger" onclick="ButtonDelete({{ $value->id_program_kuliah }})"><i class="fa fa-trash"></i> Delete</button></td>
                  </tr>
