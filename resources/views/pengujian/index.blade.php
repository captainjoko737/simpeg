...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li class="active"><a href="#"><i class="fa fa-chain"></i> Pengujian</a></li>
      </ol>
    </section>
              ...
              <table class="table table-hover">
                ...
                @foreach ($result as $key => $value)
                  ...
                  <tr>
                    ...
                    <td class="text-center"><button class="btn btn-sm btn-success" onclick="detail({{$value->id_penguji_ujian_akhir }})"><i class="fa fa-eye"></i> Detail</button> <button class="btn btn-sm btn-info" onclick="edit({{$value->id_penguji_ujian_akhir }})"><i class="fa fa-pencil"></i> Edit</button> <button class="btn btn-sm btn-danger" onclick="ButtonDelete({{ $value->id_penguji_ujian_akhir }})"><i class="fa fa-trash"></i> Delete</button></td>
                  </tr>
...
<script type="text/javascript">
    ...
    function add() {
        location.href='/pengujian/add';
    }

    function detail(id) {
        location.href='/pengujian/detail/'+id;
    }

    function edit(id) {
        console.log('EDIT ', id);
        location.href='/pengujian/edit/'+id;
    }
    ...
    function deleteConfirm() {
        ...
        var data = {
                "id_penguji_ujian_akhir" : selectedID,
                "_token" : _token};

          $.ajax({
             type: 'delete',
             url: '{{url("/pengujian/delete")}}',
             data: data,
