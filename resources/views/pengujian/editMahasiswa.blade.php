      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => 'putPengujianMahasiswa','files'=>true, 'method' => 'PUT')) !!}
            <div class="box-body">  
                ...
                <div class="form-group" hidden>
                  <label>id</label>
                  <input type="text" class="form-control" required id="id_mahasiswa_ujian_akhir" name="id_mahasiswa_ujian_akhir" value="{{ $result->id_mahasiswa_ujian_akhir }}">
                </div>
