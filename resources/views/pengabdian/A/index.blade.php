                ...
                <tbody>
                    @foreach ($result as $key => $value)
                      ...
                      <tr>
                        ...
                        <td><button class="btn btn-sm btn-info" onclick="edit({{$value->id_pengabdian }})"><i class="fa fa-pencil"></i> Edit</button> <button class="btn btn-sm btn-danger" onclick="ButtonDelete({{ $value->id_pengabdian }})"><i class="fa fa-trash"></i> Delete</button></td>
                      </tr>
...
<script type="text/javascript">
    ...
    function add() {
        location.href='/pengabdian/a/add';
    }

    function edit(id) {
        console.log('EDIT ', id);
        location.href='/pengabdian/a/edit/'+id;
    }
    ...
    function deleteJabatanStruktural() {
        ...
        var data = {
                "id_pengabdian_a" : selectedID,
                "_token" : _token};

          $.ajax({
             type: 'delete',
             url: '{{url("/pengabdian/a/delete")}}',
             data: data,
