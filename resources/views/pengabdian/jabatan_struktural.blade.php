              ...
              <div class="box-tools">
                <div class="input-group input-group-sm" style="width: 150px;">
                  ...
                  <div class="button pull-right">
                    <button type="submit" class="btn btn-primary btn-sm" onclick="tambahJabatanStruktural()"><i class="fa fa-plus"></i> Tambah Jabatan Struktural</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <table class="table table-hover">
                ...
                @foreach ($jabatan_struktural as $key => $value)
                  ...
                  <tr>
                    ...
                    <td><button class="btn btn-sm btn-info" onclick="editJabatanStruktural({{$value['id_jabatan_struktural']}})"><i class="fa fa-pencil"></i> Edit</button> <button class="btn btn-sm btn-danger" onclick="ButtonDelete({{$value['id_jabatan_struktural']}})"><i class="fa fa-trash"></i> Delete</button></td>
                  </tr>
