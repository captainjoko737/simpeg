                ...
                <tbody>
                    @foreach ($result as $key => $value)
                      ...
                      <tr>
                        ...
                        <td><button class="btn btn-sm btn-info" onclick="edit({{$value->id_prodi }})"><i class="fa fa-pencil"></i></button> <button class="btn btn-sm btn-danger" onclick="ButtonDelete({{ $value->id_prodi }})"><i class="fa fa-trash"></i> </button></td>
                      </tr>
...
<script type="text/javascript">
    ...
    function add() {
        location.href='/prodi/add';
    }

    function edit(id) {
        console.log('EDIT ', id);
        location.href='/prodi/edit/'+id;
    }
