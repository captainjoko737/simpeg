...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li class="active"><a href="#"><i class="fa fa-chain"></i> Membina Kegiatan Mahasiswa</a></li>
      </ol>
    </section>
...
<script type="text/javascript">
    ...
    function add() {
        location.href='/kegiatan/mahasiswa/add';
    }

    function edit(id) {
        console.log('EDIT ', id);
        location.href='/kegiatan/mahasiswa/edit/'+id;
    }
    ...
    function deleteConfirm() {
        ...
        var data = {
                "id_kegiatan_mahasiswa" : selectedID,
                "_token" : _token};

          $.ajax({
             type: 'delete',
             url: '{{url("/kegiatan/mahasiswa/delete")}}',
             data: data,
