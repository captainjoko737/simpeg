      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => 'postPublikasiKarya','files'=>true)) !!}
            <div class="box-body">
                ...
                <div class="form-group">
                  <label>Tanggal</label>
                  <input type="text" class="form-control" required id="tanggal" name="tanggal" placeholder="Masukkan Tanggal" value="">
                </div>
