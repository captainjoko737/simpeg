      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => 'putPublikasiKarya','files'=>true, 'method' => 'PUT')) !!}
            <div class="box-body">  

                <div class="form-group hide">
                  <label>id</label>
                  <input type="text" class="form-control" required id="id_karya_ilmiah" name="id_karya_ilmiah" value="{{ $result->id_karya_ilmiah }}">
                </div>

                <div class="form-group">
                  <label>Jenis Karya Ilmiah</label>
                  <select class="form-control" id="is_publikasi" name="is_publikasi" required>
                    <option value="">- Pilih Jenis Karya Ilmiah</option>
                    <option value="1">Hasil Penelitian atau pemikiran yang dipublikasikan</option>
                    <option value="0">Hasil Penelitian atau hasil pemikiran yang tidak dipublikasikan</option>
                  </select>
                </div>

                <div class="form-group">
                  <label>Kategori Karya Ilmiah</label>
                  <select class="form-control" id="kategori" name="kategori" required>
                    <option value="">- Pilih kategori -</option>
                    <option value="Dalam Bentuk Buku">Dalam Bentuk Buku</option>
                    <option value="Dalam Majalah Ilmiah">Dalam Majalah Ilmiah</option>
                    <option value="Melalui Seminar Internasional">Melalui Seminar Internasional</option>
                    <option value="Melalui Seminar Nasional">Melalui Seminar Nasional</option>
                    <option value="Dalam Koran/Majalah Populer/Umum">Dalam Koran/Majalah Populer/Umum</option>
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" required id="tanggal" name="tanggal" placeholder="Masukkan Tanggal Kegiatan" value="{{ $result->tanggal }}">
                </div>
...
var is_publikasi = '{!! $result->is_publikasi !!}';
document.getElementById("is_publikasi").value = is_publikasi;
var kategori = '{!! $result->kategori !!}';
