      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => 'putPenelitianE','files'=>true, 'method' => 'PUT')) !!}
            <div class="box-body">  
                ...
                <div class="form-group hide">
                  <label>id</label>
                  <input type="text" class="form-control" required id="id_rancangan_karya_seni" name="id_rancangan_karya_seni" value="{{ $result->id_rancangan_karya_seni }}">
                </div>
