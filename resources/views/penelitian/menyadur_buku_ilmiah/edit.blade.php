      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => 'putPenelitianB','files'=>true, 'method' => 'PUT')) !!}
            <div class="box-body">  
                ...
                <div class="form-group hide">
                  <label>id</label>
                  <input type="text" class="form-control" required id="id_menyadur_buku_ilmiah" name="id_menyadur_buku_ilmiah" value="{{ $result->id_menyadur_buku_ilmiah }}">
                </div>
