                ...
                <tbody>
                    @foreach ($result as $key => $value)
                      ...
                      <tr>
                        ...
                        <td><button class="btn btn-sm btn-info" onclick="edit({{$value->id_menyadur_buku_ilmiah }})"><i class="fa fa-pencil"></i> Edit</button> <button class="btn btn-sm btn-danger" onclick="ButtonDelete({{ $value->id_menyadur_buku_ilmiah }})"><i class="fa fa-trash"></i> Delete</button></td>
                      </tr>
...
<script type="text/javascript">
    ...
    function add() {
        location.href='/penelitian/b/add';
    }

    function edit(id) {
        console.log('EDIT ', id);
        location.href='/penelitian/b/edit/'+id;
    }
    ...
    function deleteJabatanStruktural() {
        ...
        var data = {
                "id_menyadur_buku_ilmiah" : selectedID,
                "_token" : _token};

          $.ajax({
             type: 'delete',
             url: '{{url("/penelitian/b/delete")}}',
             data: data,
