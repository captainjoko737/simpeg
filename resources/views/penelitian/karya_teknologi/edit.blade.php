      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => 'putPenelitianD','files'=>true, 'method' => 'PUT')) !!}
            <div class="box-body">  
                ...
                <div class="form-group hide">
                  <label>id</label>
                  <input type="text" class="form-control" required id="id_karya_teknologi" name="id_karya_teknologi" value="{{ $result->id_karya_teknologi }}">
                </div>
