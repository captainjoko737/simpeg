                ...
                <tbody>
                    @foreach ($result as $key => $value)
                      ...
                      <tr>
                        ...
                        <td><button class="btn btn-sm btn-info" onclick="edit({{$value->id_karya_teknologi }})"><i class="fa fa-pencil"></i> Edit</button> <button class="btn btn-sm btn-danger" onclick="ButtonDelete({{ $value->id_karya_teknologi }})"><i class="fa fa-trash"></i> Delete</button></td>
                      </tr>
...
<script type="text/javascript">
    ...
    function add() {
        location.href='/penelitian/d/add';
    }

    function edit(id) {
        console.log('EDIT ', id);
        location.href='/penelitian/d/edit/'+id;
    }
    ...
    function deleteJabatanStruktural() {
        ...
        var data = {
                "id_karya_teknologi" : selectedID,
                "_token" : _token};

          $.ajax({
             type: 'delete',
             url: '{{url("/penelitian/d/delete")}}',
             data: data,
