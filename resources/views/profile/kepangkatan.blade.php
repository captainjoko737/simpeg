              ...
              <div class="box-tools">
                <div class="input-group input-group-sm" style="width: 150px;">
                  ...
                  <div class="button pull-right">
                    <button type="button" class="btn btn-primary btn-sm" onclick="tambahKepangkatan()"><i class="fa fa-plus"></i> Tambah Kepangkatan</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <table class="table table-hover">
                ...
                @foreach ($kepangkatan as $key => $value)
                  ...
                  <tr>
                    ...
                    <td>{{ $value['masa_kerja_tahun'] }}</td>
                    <td>{{ $value['masa_kerja_bulan'] }}</td>
